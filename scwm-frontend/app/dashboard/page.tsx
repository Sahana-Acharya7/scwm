...
export default function Home() {
  ...
  useEffect(() => {
    // This retrieves the name you entered on the login page
    const storedName = sessionStorage.getItem('scwm_user');
  ...
  Sustainability Dashboard for <span className="text-emerald-500">{userName}</span>
</h2>
